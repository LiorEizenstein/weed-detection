...
# Stub launch/ROS dependencies so the launch module can be imported
...
class TestCalibrationModeSwitch:
    ...
    def test_calibrated_mode_uses_quaternion_args(self, tmp_path, monkeypatch):
        ...
        # Write a temporary camera_params.yaml with calibrated=true
        cal_params = {
            'calibrated': True,
            'mount': {
        ...
        # Patch open() inside the launch module to return our temp file
        import builtins
